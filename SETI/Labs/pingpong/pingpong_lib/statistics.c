...
/*** TO BE DONE START ***/
double time_prev = ((double)(previous->tv_sec * 1.0e09) + previous->tv_nsec);
double time_last = ((double)(last->tv_sec * 1.0e09) + last->tv_nsec);
return (double)((time_last - time_prev) / 1.0e06);	
/*** TO BE DONE END ***/
